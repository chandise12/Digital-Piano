...
#define PINB_Pin GPIO_PIN_1
#define PINB_GPIO_Port GPIOB
#define PINC_Pin GPIO_PIN_2
#define PINC_GPIO_Port GPIOB
...
#define PIND_Pin GPIO_PIN_5
#define PIND_GPIO_Port GPIOB
